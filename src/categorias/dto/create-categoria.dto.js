...
var CreateCategoriaDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateCategoriaDto() {
                ...
                __runInitializers(this, _prefijo_extraInitializers);
            }
            return CreateCategoriaDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _nombre_decorators = [(0, class_validator_1.IsString)({ message: 'El nombre debe ser un texto' }), (0, class_validator_1.IsNotEmpty)({ message: 'El nombre es obligatorio' })];
            _prefijo_decorators = [(0, class_validator_1.IsString)({ message: 'El prefijo debe ser un texto' }), (0, class_validator_1.IsNotEmpty)({ message: 'El prefijo es obligatorio' }), (0, class_validator_1.MaxLength)(10, { message: 'El prefijo no puede tener más de 10 caracteres' })];
