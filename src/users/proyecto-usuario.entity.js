...
exports.ProyectoUsuario = void 0;
var typeorm_1 = require("typeorm");
var proyecto_entity_1 = require("../proyectos/proyecto.entity");
var user_entity_1 = require("./user.entity");
var ProyectoUsuario = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('proyecto_usuarios')];
    ...
    var ProyectoUsuario = _classThis = /** @class */ (function () {
        function ProyectoUsuario_1() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.proyecto = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _proyecto_initializers, void 0));
            this.usuario = (__runInitializers(this, _proyecto_extraInitializers), __runInitializers(this, _usuario_initializers, void 0));
            __runInitializers(this, _usuario_extraInitializers);
        }
        return ProyectoUsuario_1;
    }());
    __setFunctionName(_classThis, "ProyectoUsuario");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _proyecto_decorators = [(0, typeorm_1.ManyToOne)(function () { return proyecto_entity_1.Proyecto; }, function (proyecto) { return proyecto.usuarios; })];
        _usuario_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; })];
        ...
        ProyectoUsuario = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProyectoUsuario = _classThis;
}();
exports.ProyectoUsuario = ProyectoUsuario;
