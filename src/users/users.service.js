...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (existingUser) {
                                throw new common_1.BadRequestException('El correo electrónico ya se encuentra registrado.');
                            }
        ...
        UsersService_1.prototype.findByEmailForLogin = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.findOne({
        ...
        UsersService_1.prototype.update = function (id, updateUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, emailExists, dataToUpdate, updatedUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            emailExists = _a.sent();
                            if (emailExists) {
                                throw new common_1.BadRequestException('El correo electrónico ya está en uso por otro usuario.');
                            }
                            _a.label = 3;
                        case 3:
                            dataToUpdate = __assign(__assign(__assign(__assign({}, (updateUserDto.username && { nombre: updateUserDto.username })), (updateUserDto.email && { email: updateUserDto.email })), (updateUserDto.password && { password: updateUserDto.password })), (updateUserDto.rol && { rol: updateUserDto.rol }));
                            updatedUser = this.userRepository.merge(user, dataToUpdate);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            user = _a.sent();
                            userDeleted = { id: user.id, nombre: user.nombre };
                            return [4 /*yield*/, this.userRepository.remove(user)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, userDeleted];
                    }
                });
            });
        };
