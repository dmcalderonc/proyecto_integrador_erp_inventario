...
var proyecto_usuario_entity_1 = require("./proyecto-usuario.entity");
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, proyecto_usuario_entity_1.ProyectoUsuario])],
