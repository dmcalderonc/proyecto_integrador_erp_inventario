...
var Proveedor = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('proveedores')];
    ...
    var _ruc_decorators;
    var _ruc_initializers = [];
    var _ruc_extraInitializers = [];
    var _razon_social_decorators;
    var _razon_social_initializers = [];
    var _razon_social_extraInitializers = [];
    ...
    var Proveedor = _classThis = /** @class */ (function () {
        function Proveedor_1() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.ruc = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _ruc_initializers, void 0));
            this.razon_social = (__runInitializers(this, _ruc_extraInitializers), __runInitializers(this, _razon_social_initializers, void 0));
            this.email = (__runInitializers(this, _razon_social_extraInitializers), __runInitializers(this, _email_initializers, void 0));
            ...
            this.estado = (__runInitializers(this, _direccion_extraInitializers), __runInitializers(this, _estado_initializers, void 0));
    ...
    __setFunctionName(_classThis, "Proveedor");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _ruc_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 13, unique: true })];
        _razon_social_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        _telefono_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        _direccion_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        ...
        __esDecorate(null, null, _ruc_decorators, { kind: "field", name: "ruc", static: false, private: false, access: { has: function (obj) { return "ruc" in obj; }, get: function (obj) { return obj.ruc; }, set: function (obj, value) { obj.ruc = value; } }, metadata: _metadata }, _ruc_initializers, _ruc_extraInitializers);
        __esDecorate(null, null, _razon_social_decorators, { kind: "field", name: "razon_social", static: false, private: false, access: { has: function (obj) { return "razon_social" in obj; }, get: function (obj) { return obj.razon_social; }, set: function (obj, value) { obj.razon_social = value; } }, metadata: _metadata }, _razon_social_initializers, _razon_social_extraInitializers);
        ...
        Proveedor = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Proveedor = _classThis;
}();
