    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isPasswordValid, error_1, userAny, payload;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.usersService.findByEmailForLogin(loginDto.email)];
                        case 1:
                            user = _a.sent();
                        ...
                        case 4:
                            error_1 = _a.sent();
                            console.log('--- [DEBUG 4] ERROR al comparar con bcrypt:', error_1.message);
                            isPasswordValid = false;
                            return [3 /*break*/, 5];
                        case 5:
                            if (!isPasswordValid) {
