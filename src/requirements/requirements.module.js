...
var requirements_service_1 = require("./requirements.service");
var requirements_controller_1 = require("./requirements.controller");
...
var RequirementsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([
                    ...
                    requirement_detail_entity_1.RequirementDetail,
                    inventario_entity_1.Inventario,
                    movimiento_inventario_entity_1.MovimientoInventario,
                    detalle_movimiento_entity_1.DetalleMovimiento
                ])
            ],
    ...
    var _classThis;
    var RequirementsModule = _classThis = /** @class */ (function () {
        function RequirementsModule_1() {
        }
        return RequirementsModule_1;
    }());
    __setFunctionName(_classThis, "RequirementsModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RequirementsModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RequirementsModule = _classThis;
}();
